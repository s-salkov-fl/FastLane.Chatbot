...
public interface IChatbotClient : IAsyncDisposable
{
	...
	/// </summary>
	Task<IReadOnlyList<ChatMessage>> GetMessagesAsync(string userId, CancellationToken cancellationToken);
	...
	/// </summary>
	Task PostAsync(string userId, string content, CancellationToken cancellationToken);
}
